...
export default function HomePage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center px-6 py-16 min-h-screen">
        <div className="max-w-6xl text-center">
          <div className="relative mb-16 p-12 rounded-3xl overflow-hidden">
            <div
            ...
            <div className="relative z-10">
              ...
              {/* Main Title */}
              <h1 className="text-6xl md:text-7xl font-black mb-8 bg-gradient-to-r from-white via-cyan-100 to-blue-200 bg-clip-text text-transparent leading-tight">
                Автоматизація
                <br />
              ...
              <div className="text-xl md:text-2xl mb-0 max-w-4xl mx-auto text-white/90 leading-relaxed font-light">
          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-8 mb-12 shadow-2xl">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Link
                href="/upload"
                className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold px-8 py-4 rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
              >
